...
!defined('SITE_ROOT')?define('SITE_ROOT',$_SERVER['DOCUMENT_ROOT'].'/gfa'):NULL;
...
!defined('PASS')?define('PASS','root'):NULL;
!defined('DB')?define('DB','gfa'):NULL;
!defined('UPLOAD_DIR')?define('UPLOAD_DIR','/var/www/html/gfa/'):NULL;
